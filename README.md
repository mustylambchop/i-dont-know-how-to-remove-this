...
<body>
  ...
  <marquee style="font-family: jua; color: black; font-size: 0.75em; text-decoration: underline;" srollamount="7" bgcolor="#E3E8FF" direction="down" height="75px" width="49%" behavior="slide" loop="1"> AESPA </marquee>
  </a>
