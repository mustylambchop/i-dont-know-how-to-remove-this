...
<br>
<div class="banner">
        <h1 class="fade-in" style="text-align: center; font-family: jua;">PHOTOCARD TEMPLATES</h1>
</div>
<h2 style="text-align: center; font-family: jua; color: black; text-decoration: underline;"> - AESPA BTS LESSERAFIM - </h2>
